...
if __name__ == '__main__': 
    ...
    #Save image size as npy file 
    #-------------------------------------------------------------------------------------------------
    img_size_list = make_size_list(img_folder_path=img_folder_path, imnames=imnaems)
    np.save('./img_size_list' , img_size_list) 
    #for memory -> Optional 
    img_size_list = None 
    #-------------------------------------------------------------------------------------------------

    #generate Region Score and Save 
